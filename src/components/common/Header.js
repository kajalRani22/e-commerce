						...
						<Container>
							...
							<Navbar.Brand eventKey={0} as={NavLink} exact to="/">
								<div className='D-header'>
									<Image src={"https://getvectorlogo.com/wp-content/uploads/2019/03/big-shop-premium-family-shop-vector-logo.png"} alt='Logo' />
							...
							<Navbar.Collapse id="navbarNavDropdown">
								<Nav activeKey={0} className="ml-auto" onSelect={closeMenu}>
									<NavDropdown title="Categories" className="border-0">
										<NavDropdown.Item eventKey={2.1} as={NavLink} activeclassname="active" to="/listing">Men's collection</NavDropdown.Item>
										<NavDropdown.Item eventKey={2.2} as={NavLink} activeclassname="active" to="/detail">Jacket's collection</NavDropdown.Item>
										<NavDropdown.Item eventKey={2.3} as={NavLink} activeclassname="active" to="/checkout">Girl's collection</NavDropdown.Item>
									</NavDropdown>
